    ...
    public $videos = [
        1 => [
            [
                ...
                'description' => 'В этом обучающем видео ролике Вы узнаете о функционале панели инструмента Insider 1.61.',
                'time' => '18:35',
            ],
            [
                'path' => '03.mp4',
                ...
                'description' => 'В этом обучающем видео ролике Вы узнаете как настраивать панель инструмента Insider 1.61.',
                'time' => '7:42',
            ],
            [
                'path' => '04.mp4',
                'closed' => true,
                'number' => '03',
                'title' => 'Торговая стратегия 1 хождение за энергией',
                'description' => 'В этом обучающем видео ролике Вы узнаете о торговой стратегии для инструмента Insider 1.61 и что такое хождение за энергией.',
                'time' => '26:34',
            ],
            [
                'path' => '01.mp4',
                ...
                'description' => 'В этом обучающем видео ролике Вы узнаете о деталях основной стратегии торговли с помощью инструмента Insider 1.61.',
                'time' => '9:51',
            ],
            [
                'path' => '02.mp4',
                'closed' => true,
                'number' => '05',
                'title' => 'Зоны спроса и предложения',
                'description' => 'В этом обучающем видео ролике Вы узнаете что такое зоны спроса и предложения, а также как их использовать в сочетании с инструментом Insider 1.61.',
                'time' => '15:41',
            ],
            [
                'path' => '05.mp4',
                'closed' => true,
                'number' => '06',
                'title' => 'Торговля с инструментом',
                'description' => 'В этом обучающем видео ролике Вы узнаете как осуществлять торговые операции с инструментом Insider 1.61.',
                'time' => '37:23',
            ],
        ]
    ];
