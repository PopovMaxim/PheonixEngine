        ...
        <div class="hero-static d-flex align-items-center justify-content-center">
            <div class="block block-rounded overflow-hidden" style="width: 800px; height: 900px;">
                <div class="text-center p-5">
                    ...
                    <p class="text-uppercase fw-bold fs-sm text-muted d-flex justify-content-center alig-items-center"><a href="{{ url('/') }}" class="me-2"><i class="fa fa-arrow-left"></i></a>Политика конфиденциальности</p>
                </div>
                <div class="block-content block-content-full" style="width: 800px; height: 600px;">
                    <iframe style="width: 100%; height: 100%;" src="https://docs.google.com/document/d/e/2PACX-1vQvsHL9sgmZrMMO7fuelehIN12XqU6JI18cWcKtb7rdeMY6ZzreDG0uzZkYV0aTVw/pub?embedded=true"></iframe>
                </div>
            </div>
        </div>
    </div>
